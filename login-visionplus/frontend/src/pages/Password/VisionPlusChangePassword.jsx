  ...
  return (
    <div className="chp-page">
      ...
      <header className="chp-header">
        <div className="chp-brand">VISIONPLUS</div>
      </header>
        ...
        <div className="chp-inner">
          ...
          <form className="chp-form-card" onSubmit={handleSubmit}>
            ...
            <div className="chp-field">
              ...
              <input className="chp-input" id="old" name="old" type="password" required />
            </div>
            ...
            <div className="chp-field">
              ...
              <input className="chp-input" id="new" name="new" type="password" required />
            </div>
            ...
            <div className="chp-field">
              ...
              <input className="chp-input" id="confirm" name="confirm" type="password" required />
            </div>
